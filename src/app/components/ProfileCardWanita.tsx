...
export default function ProfileCardWanita() {
  return (
    <div className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 backdrop-blur-sm border-b border-gray-300 shadow-lg hover:shadow-xl transition-all duration-300 animate-slide-up-delay-4"
      style={{
        backgroundImage: `
      ...
      <div className="relative z-10 text-center p-4">
        ...
        <ProfilePhoto name="Han So Hee" folderPath="/images/slideshow-wanita" />
        {/* Nama Lengkap */}
        <h4 className="text-lg font-bold text-gray-800 mb-2 drop-shadow-sm">Han So Hee S.Sn</h4>
